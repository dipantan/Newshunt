    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //create chrome custom tab intent
                CustomTabsIntent.Builder customIntent = new CustomTabsIntent.Builder();
                //set the toolbar color
                customIntent.setToolbarColor(ContextCompat.getColor(mContext, R.color.color_app_bar_text));
                // Convert the String URL into a URI object (to pass into the Intent constructor)
                Uri newsUri = Uri.parse(currentNews.getUrl());
                openCustomTab((Activity) mContext, customIntent.build(), newsUri);
...
//            holder.thumbnailImageView.setVisibility(View.VISIBLE);
    ...
    private void setTextSize(ViewHolder holder) {
        ...
        if (textSize.equals(mContext.getString(R.string.settings_text_size_medium_value))) {
            ...
            holder.trailTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    mContext.getResources().getDimension(R.dimen.textsize));
    ...
    private String formatDate(String dateStringUTC) {
        ...
        SimpleDateFormat simpleDateFormat =
                new SimpleDateFormat("yyyy-MM-dd'T'kk:mm:ss'Z'", Locale.getDefault());
